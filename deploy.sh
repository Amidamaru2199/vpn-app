...
# Скрипт для быстрого деплоя VPN App на bot.adronvpn.ru
# 
# Использование:
...
echo "🚀 Начинаем деплой VPN App на https://bot.adronvpn.ru/vpn-app/"
...
echo "🌐 Приложение доступно по адресу: https://bot.adronvpn.ru/vpn-app/"
echo ""
