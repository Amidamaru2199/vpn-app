...
# Скрипт для быстрого деплоя VPN App на app.adron-soft.ru
# 
# Использование:
...
SERVER_HOST="77.110.105.100"          # IP адрес твоего сервера  
SERVER_PATH="/var/www/vpn-app/dist"   # Путь на сервере

# ========== ДЕПЛОЙ ==========

echo "🚀 Начинаем деплой VPN App на https://app.adron-soft.ru/vpn-app/"
...
echo "🌐 Приложение доступно по адресу: https://app.adron-soft.ru/vpn-app/"
echo ""
